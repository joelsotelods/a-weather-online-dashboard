...
* The nav must have some kind of behavior (e.g. background color changes).
...
* You may use the weather data or choose another dataset. Alternatively, you may use the included cities dataset and pull the images from an assets folder.
